...
class _BeforePoseDetectorState extends State<BeforePoseDetector> {
  ...
  final PoseDetector _imagePoseDetector =
    ...
    return Center(
      child: Container(
        ...
        child: CarouselSlider(
          ...
          items: widget.sportsExpert.postures!
              .map((item) => Card(
                    elevation: 2,
                    color: Colors.white,
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          padding: EdgeInsets.only(left: 20),
                          child: SizedBox(
                              height: 120, child: Text(item.postureComment)),
                        ),
                        Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children:
                                widget.sportsExpert.postures!.map((urlOfItem) {
                              int index = widget.sportsExpert.postures!
                                  .indexOf(urlOfItem);
                              return Container(
                                width: 10.0,
                                height: 10.0,
            ...
            Navigator.push(
              ...
              MaterialPageRoute(
                  builder: (context) => PoseDetectorView(
                        sportsExpert: widget.sportsExpert,
